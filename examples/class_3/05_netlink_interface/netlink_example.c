...
static void netlink_recv_msg(struct sk_buff *skb)
{
    ...
    case MSG_TYPE_HELLO:
        message_counter++;
        send_message_to_user(pid, MSG_TYPE_HELLO, message_counter, "Hello from kernel!");
        break;
        
    case MSG_TYPE_COUNTER:
        send_message_to_user(pid, MSG_TYPE_COUNTER, message_counter, "Current counter value");
        break;
        
    case MSG_TYPE_STATUS:
        send_message_to_user(pid, MSG_TYPE_STATUS, 0, "Kernel module is running");
        break;
