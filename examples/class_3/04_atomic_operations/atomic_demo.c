...
static ssize_t atomic_basic_write(struct file *file, const char __user *buffer, size_t count, loff_t *pos)
{
    char input[32];
    char operation[16];
    int value = 0;
...
static ssize_t atomic_advanced_write(struct file *file, const char __user *buffer, size_t count, loff_t *pos)
{
    char input[32];
    char operation[16];
    int value = 0;
...
// Bit operations:
static ssize_t atomic_bits_write(struct file *file, const char __user *buffer, size_t count, loff_t *pos)
{
    char input[32];
    char operation[16];
    int bit_num = 0;
